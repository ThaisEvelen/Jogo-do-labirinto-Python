...
Funções utilitárias:
- imprime_instrucoes(): lê instruções de um arquivo (se existir) ou imprime um texto default
- animacao_festa(): pequena função recursiva que imprime uma "festa" textual para comemorar
- funções visuais cyberpunk: imprime_titulo, status_jogador, game_over_visual
"""
